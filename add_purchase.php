        ...
        <form id="purchaseForm" action="process_purchase.php" method="POST">
            ...
            <div class="row mb-3">
                <div class="col-md-4">
                    ...
                    <input type="text" id="gl_inventory" name="gl_inventory" class="form-control" placeholder="Enter GL inventory account">
                </div>
                <div class="col-md-4">
                    <label for="gl_cost_of_sales" class="form-label">GL Cost of Sales:</label>
                    <input type="text" id="gl_cost_of_sales" name="gl_cost_of_sales" class="form-control" placeholder="Enter GL cost of sales account">
                </div>
                <div class="col-md-4">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="number" id="discount" name="discount" class="form-control" placeholder="Enter discount" step="0.01" min="0" max="100">
                </div>
                <div class="col-md-6">
                    <label for="description" class="form-label">Description:</label>
                    <textarea id="description" name="description" rows="4" class="form-control" placeholder="Enter purchase details"></textarea>
                </div>
            </div>
